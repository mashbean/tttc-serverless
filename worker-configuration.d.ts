/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4266bf51640ebf181a600be6ab4cead0)
...
interface __BaseEnv_Env {
	...
	BUILD_SHA: "";
	REPORT: DurableObjectNamespace<import("./src/index").ReportRoom>;
	COORDINATOR: DurableObjectNamespace<import("./src/index").Coordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ReportRoom" | "Coordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODE" | "MAX_ROWS" | "DAILY_NEURON_CEILING" | "BUILD_SHA">> {}
}
